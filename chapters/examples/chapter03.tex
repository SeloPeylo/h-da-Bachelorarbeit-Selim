...
Zusammengefasst aus \citet{Gupta:2017}
\begin{itemize}
...
Die Cloud-Technologie ist nicht nur eine standardisierende Möglichkeit für die seit langem angeforderte \ac{SOA} \cite{Brockhoff2006} in Banken. Sie ist möglicherweise Brandbeschleuniger für die digitale Transformation ganzer Branchen. 
\bigskip
\\
...
Der Ansatz neue Technologien anzunehmen hat weitreichende Auswirkungen \citet{Gupta:2017} auf ein Unternehmen. Eine gewisse Risikoakzeptanz dieser Auswirkungen muss vorhanden sein, um sich für neue Technologien zu überwinden. Handlungsunfähigkeit ist oft das größere Risiko. 
...
\end{quote}
\bigskip
Ähnliche Probleme existieren innerhalb der IT, insbesondere in der Zusammenarbeit zwischen Entwicklung und Betrieb \citet{Disterer2013}. Ansätze aus DevOps können hierbei die Zusammenarbeit innerhalb der IT verstärken. Im Finanzwesen sind Entwicklung und Betrieb jedoch streng voneinander getrennt. Dies wird durch die strikte Trennung zwischen Test- und Produktivumgebung bedingt \citet{MaRisk:2017} und ist ein einschränkender Faktor für die Softwareentwicklungsumgebung.

...
\subsection{Digitale Transformation: Ein kontinuierlicher Veränderungsprozess}
\begin{figure}[htbp]
 \centering
 \includegraphics[width=1.0\textwidth]{gfx/digital-transformation-lifecycle-by-selim2.PNG}
 \caption{Lebenszyklus der digitalen Transformation (Quelle: eigene Darstellung, Heißluftballon von \citet{maidis_2006})\label{fig:digit-trans}
 }
\end{figure}

\paragraph{Lebenszyklus Digitale Transformation}

Abb, \ref{fig:digit-trans} ist aus der Zusammenfassung von antreibenden und einschränkenden Faktoren entstanden. 

Das in dieser Arbeit hervorgehobene Kontinuitätsprinzip für die  Veränderungsprozesse \cite{Bussmann2006} ist in Anlehnung am DevOps Lebenszyklus \ref{fig:devops} \cite{Alt2017} eingeflossen. Der Begriff der antreibenden und einschränkenden Faktoren generierte in Zusammenhang mit dem Transformationsziel der heutigen IT-Architekturen hin zu einer Cloud-Architektur die Idee von einem Heißluftballon als Metapher für die sich transformierende Organisation.
...
Zu den Antreibenden Faktoren sind weitere Voraussetzungen für Veränderungsprozesse ergänzt worden. Analog hierzu steht fest, ein Verbrennungsprozess beginnt nicht allein mit dem Treibstoff. Dieser lässt sich mit verschiedenen Parametern vorher abschätzen sowie messen. Der Prozess setzt auch einen Auslöser oder Funken voraus, um ihn zu beginnen. Dieser kann kontrolliert anhand einer Strategie gesetzt werden oder durch äußere Einflüsse unkontrolliert in Form einer Disruption oder Diskontinuität des aktuellen Zustands. Als Metapher für Disruption könnte in Abb. \ref{fig:digit-trans} ein Blitzeinschlag gewählt werden und für Diskontinuität eine Sturzlandung. Der Eintritt des Prozesses kann jedoch ab einem gewissen Punkt vorausgesehen werden durch Impulse. Analog zum Blitzeinschlag wären es die aufbrauenden Gewitterwolken.

Veränderungen unterliegen kreativen Prozessen \cite[S.14]{Alt2017}, weswegen eine kreative Methode sich für ihre Darstellung eignen kann.

Die Veränderungsprozesse bewegen mit genug Antrieben ein statisches Abbild der Organisation, welcher im Korb des Heißluftballoons liegt und einen Zustand der Organisation beschreibt. Der Korb ist in sich geschlossen und beinhaltet den Ablauf und Aufbau des Kerngeschäfts. Dieser trägt zu ihrer Unterstützung viele weitere Funktionen mit, die jeweils die Bewegung der Organisation durch ihr Gewicht exponentiell einschränken.

Ein statisches Abbild mit Prozessbeschreibungen und Ausführung als eine in sich geschlossene Einheit ist aus der Containervirtualisierung von Systemen bekannt. Mit zunehmender Automatisierung der Geschäftsprozesse finden sich auch zunehmende Gemeinsamkeiten zwischen Organisationen und IT-Systemen. Der Vergleich mit einer Container-Anwendung ist daher durchaus berechtigt.